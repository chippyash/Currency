...
The library is currently under development to support a 'Simple Accounting' (double entry book-keeping) library.
It is based on the chippyash\StrongType set of classes and offers:
